...
<head>
    ...
    <script src="view/javascript/jquery/jquery.js" type="text/javascript"></script>
    <!--<script src="view/javascript/jquery/selects.js" type="text/javascript"></script>-->
    ...
    <script type="text/javascript" src="view/javascript/jquery/slide_toggle.js"></script>
...
<ul class="left" style="display: none;">
    ...
    <li id="catalog"><a class="top"><?php echo $text_catalog; ?></a>
        <ul>
            ...
            <li><a href="<?php echo $catalog_video; ?>"><?php echo $text_catalog_video; ?></a></li>
            <li><a href="<?php echo $catalog_article; ?>"><?php echo $text_catalog_article; ?></a></li>
            <li><a href="<?php echo $article; ?>"><?php echo $text_article; ?></a></li>
            <li><a href="<?php echo $seo; ?>"><?php echo $text_seo; ?></a></li>
            <li><a href="<?php echo $product_price; ?>"><?php echo $text_product_price; ?></a></li>
        </ul>
    </li>
    <li id="extension"><a class="top"><?php echo $text_extension; ?></a>
        <ul>
            ...
            <li><a href="<?php echo $subscribero; ?>"><?php echo $text_subscribero; ?></a></li>
            <li><a href="<?php echo $translate_seo; ?>"><?php echo $text_translate; ?></a></li>
        </ul>
    </li>
        ...
        <ul>
            ...
            <li><a class="parent"><?php echo $text_localisation; ?></a>
                <ul>
                    ...
                    <li><a href="<?php echo $depart; ?>"><?php echo $text_depart; ?></a></li>
                    ...
                    <li><a href="<?php echo $price_after; ?>"><?php echo $text_price_after; ?></a></li>
                    <li><a href="<?php echo $price_prefix; ?>"><?php echo $text_price_prefix; ?></a></li>
                </ul>
            </li>
