...
<body>
<div id="container">
  <div id="menu"><a id="create" class="button" style="background-image: url('view/image/watermanager/folder.png');"><?php echo $button_folder; ?></a><a id="delete" class="button" style="background-image: url('view/image/watermanager/edit-delete.png');"><?php echo $button_delete; ?></a><a id="move" class="button" style="background-image: url('view/image/watermanager/edit-cut.png');"><?php echo $button_move; ?></a><a id="copy" class="button" style="background-image: url('view/image/watermanager/edit-copy.png');"><?php echo $button_copy; ?></a><a id="rename" class="button" style="background-image: url('view/image/watermanager/edit-rename.png');"><?php echo $button_rename; ?></a><a id="upload" class="button" style="background-image: url('view/image/watermanager/upload.png');"><?php echo $button_upload; ?></a><a id="refresh" class="button" style="background-image: url('view/image/watermanager/refresh.png');"><?php echo $button_refresh; ?></a></div>
...
$(document).ready(function () { 
	$('#column-left').tree({
		data: { 
			...
			opts: { 
				method: 'POST', 
				url: 'index.php?route=common/watermanager/directory&token=<?php echo $token; ?>'
			} 
		},
		selected: 'top',
		ui: {		
		...
		callback: {
			...
			onselect: function (NODE, TREE_OBJ) {
				$.ajax({
					url: 'index.php?route=common/watermanager/files&token=<?php echo $token; ?>',
					type: 'POST',
	...
	$('#create').bind('click', function () {
		...
		if (tree.selected) {
			...
			$('#dialog input[type=\'button\']').bind('click', function () {
				$.ajax({
					url: 'index.php?route=common/watermanager/create&token=<?php echo $token; ?>',
					type: 'POST',
	...
	$('#delete').bind('click', function () {
		...
		if (path) {
			$.ajax({
				url: 'index.php?route=common/watermanager/delete&token=<?php echo $token; ?>',
				type: 'POST',
	...
	$('#move').bind('click', function () {
		...
		$('#dialog select[name=\'to\']').load('index.php?route=common/watermanager/folders&token=<?php echo $token; ?>');
		...
		$('#dialog input[type=\'button\']').bind('click', function () {
			...
			if (path) {																
				$.ajax({
					url: 'index.php?route=common/watermanager/move&token=<?php echo $token; ?>',
					type: 'POST',
	...
	$('#copy').bind('click', function () {
		...
		$('#dialog input[type=\'button\']').bind('click', function () {
			...
			if (path) {																
				$.ajax({
					url: 'index.php?route=common/watermanager/copy&token=<?php echo $token; ?>',
					type: 'POST',
	...
	$('#rename').bind('click', function () {
		...
		$('#dialog input[type=\'button\']').bind('click', function () {
			...
			if (path) {		
				$.ajax({
					url: 'index.php?route=common/watermanager/rename&token=<?php echo $token; ?>',
					type: 'POST',
					data: 'path=' + encodeURIComponent(path) + '&name=' + encodeURIComponent($('#dialog input[name=\'name\']').val()),
					dataType: 'json',
					success: function(json) {
	...
	new AjaxUpload('#upload', {
		action: 'index.php?route=common/watermanager/upload&token=<?php echo $token; ?>',
		name: 'image',
		autoSubmit: false,
		responseType: 'json',
