    ...
    <div id="tab-data">
        <table class="form">
            ...
            <tr>
                ...
                <td><?php if ($support) { ?>
                    <input type="checkbox" name="support" value="1" checked="checked" />
                    <?php } else { ?>
            ...
            <tr>
                <td><?php echo $entry_product; ?>
                    <br />
                    <?php echo $entry_show_in_product; ?>
                </td>
                <td><?php if ($product) { ?>
                    <input type="checkbox" name="product" value="1" checked="checked" />
                    <?php } else { ?>
            ...
            <tr>
                ...
                <td class="scroll">
                    <div class="scrollbox">
                        ...
                        <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                        <div class="<?php echo $class; ?>">
                            <?php if (in_array($category['category_id'], $information_category)) { ?>
                            <input type="checkbox" name="information_category[]" value="<?php echo $category['category_id']; ?>" checked="checked" />
                            <?php echo $category['name']; ?>
                            <?php } else { ?>
                            <input type="checkbox" name="information_category[]" value="<?php echo $category['category_id']; ?>" />
                            <?php echo $category['name']; ?>
                            <?php } ?>
                        </div>
                        <?php } ?>
            ...
            <tr>
                ...
                <td>
                    <?php if ($special) { ?>
                    <input type="checkbox" name="special" value="1" checked="checked" />
                    <?php } else { ?>
