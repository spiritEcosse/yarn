...
<div class="heading">
    ...
    <div class="buttons">
        <a onclick="$('#form').attr('action', '<?php echo $switch . '&switch=1'; ?>'); $('#form').submit();" class="button"><?php echo $text_on; ?></a>
        <a onclick="$('#form').attr('action', '<?php echo $switch . '&switch=0'; ?>'); $('#form').submit();" class="button"><?php echo $text_off; ?></a>
...
<form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
    <div>
        <?php echo $on_page; ?>:
        <a href="<?php echo $href_limit; ?>" class="button"><?php echo $limit; ?></a>
    </div>

    <div class="pagination">
        <?php if (isset($text_total_prod)) { ?>
        <?php echo $text_total_prod; ?>:
        <?php } ?>
    ...
    <table class="list">
        ...
        <tr>
            ...
            <td class="left"><?php if ($sort == 'p.status') { ?>
                ...
                <?php } ?></td>
            <td class="left"><?php echo $column_view_prod; ?></td>
        ...
        <tr class="filter" >
            ...
            <td><select name="filter_category" id="filter_category" onchange="filter();">
            ...
            <td>
                <select name="filter_manufacturer" id="filter_manufacturer" onchange="filter();">
                    <option value="0"></option>
                    <?php $man_selected = ''; ?>
        ...
        <tr class="<?php echo $class; ?>">
            ...
            <td class="left">
                <a onclick="window.open('<?php echo $product['href_view_prod']; ?>','_blank')" ><?php echo $column_view_prod; ?></a>
            </td>
            <td class="right">
