            ...
            <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
                <table class="list">
                    ...
                    <tr>
                        ...
                        <td class="aright"><?php echo $column_sort_order; ?></td>
                    ...
                    <tr>
                        <td style="text-align: center;"><?php if ($category['selected']) { ?>
                            <input type="checkbox" name="selected[]" value="<?php echo $category['category_article_id']; ?>" checked="checked" />
                            <?php } else { ?>
                            <input type="checkbox" name="selected[]" value="<?php echo $category['category_article_id']; ?>" />
                            <?php } ?></td>
                        ...
                        <?php } ?>
                        <td class="right"><?php echo $category['category_article_sort_order']; ?></td>
