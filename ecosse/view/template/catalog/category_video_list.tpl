                ...
                <table class="list">
                    ...
                    <tr>
                        <td style="text-align: center;"><?php if ($category['selected']) { ?>
                            <input type="checkbox" name="selected[]" value="<?php echo $category['category_video_id']; ?>" checked="checked" />
                            <?php } else { ?>
                            <input type="checkbox" name="selected[]" value="<?php echo $category['category_video_id']; ?>" />
                            <?php } ?></td>
                        ...
                        <?php } ?>
                        <td class="right"><?php echo $category['category_video_sort_order']; ?></td>
