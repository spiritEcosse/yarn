...
class ControllerLocalisationCity extends Controller {
    ...
    protected function getForm() {
        ...
        $this->data['entry_zone_price'] = $this->language->get('entry_zone_price');
        ...
        if (isset($this->request->post['zone_price'])) {
            $this->data['zone_price'] = $this->request->post['zone_price'];
        } elseif (!empty($city_info)) {
            $this->data['zone_price'] = $city_info['zone_price'];
        } else {
            $this->data['zone_price'] = '';
        }
    ...
    protected function validateForm() {
        ...
        if ((int)$this->request->post['zone_id'] == 0) {
