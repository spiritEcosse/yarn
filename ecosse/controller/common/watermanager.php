<?php
class ControllerCommonWatermanager extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$this->template = 'common/watermanager.tpl';
	...
	public function create() {
		$this->load->language('common/watermanager');
		...
		if (!$this->user->hasPermission('modify', 'common/watermanager')) {
