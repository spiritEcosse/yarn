...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_furniture_order_category'] = $this->language->get('text_furniture_order_category');
		$this->data['text_furniture_order']       = $this->language->get('text_furniture_order');
        ...
        $this->data['text_category_fabric'] = $this->language->get('text_category_fabric');
		...
		$this->data['text_price_after'] = $this->language->get('text_price_after');
		$this->data['text_price_prefix'] = $this->language->get('text_price_prefix');
		$this->data['text_length_class'] = $this->language->get('text_length_class');
		$this->data['text_vqmod_manager'] = $this->language->get('text_vqmod_manager');
        $this->data['text_zone'] = $this->language->get('text_zone');
        $this->data['text_city'] = $this->language->get('text_city');
        $this->data['text_depart'] = $this->language->get('text_depart');
        $this->data['text_seo'] = $this->language->get('text_seo');
        $this->data['text_video'] = $this->language->get('text_video');
		$this->data['text_catalog_video'] = $this->language->get('text_catalog_video');
		$this->data['text_catalog_article'] = $this->language->get('text_catalog_article');
		$this->data['text_article'] = $this->language->get('text_article');

        $this->data['text_subscribero'] = $this->language->get('text_subscribero');
        $this->data['text_price_excel'] = $this->language->get('text_price_excel');
        ...
        if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['category_fabric'] = $this->url->link('catalog/category_fabric', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['product_price'] = $this->url->link('catalog/product_price', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['filter'] = $this->url->link('catalog/filter', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['depart'] = $this->url->link('localisation/novapochta', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['price_prefix'] = $this->url->link('localisation/price_prefix', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['price_after'] = $this->url->link('localisation/price_after', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['furniture_category'] = $this->url->link('catalog/furniture_order_category', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['price_excel'] = $this->url->link('catalog/price_excel', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['translate_seo'] = $this->url->link('extension/translate_seo', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['seo'] = $this->url->link('catalog/seo', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['video'] = $this->url->link('catalog/video', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['catalog_video'] = $this->url->link('catalog/category_video', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['catalog_article'] = $this->url->link('catalog/category_article', 'token=' . $this->session->data['token'], 'SSL');
