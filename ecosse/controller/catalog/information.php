...
class ControllerCatalogInformation extends Controller {
    ...
    private function getForm() {
        ...
        if (isset($this->request->post['information_category'])) {
            $this->data['information_category'] = $this->request->post['information_category'];
        } elseif (isset($this->request->get['information_id'])) {
            $this->data['information_category'] = $this->model_catalog_information->getInformationCategories($this->request->get['information_id']);
        } else {
            $this->data['information_category'] = array();
        }
        ...
        if (isset($this->request->post['support'])) {
            ...
            $this->data['support'] = $information_info['support'];
        } else {
            $this->data['support'] = 0;
        }
        ...
        if (isset($this->request->post['info'])) {
            ...
            $this->data['info'] = $information_info['info'];
        } else {
            $this->data['info'] = 0;
        }
        ...
        if (isset($this->request->post['special'])) {
            ...
            $this->data['special'] = $information_info['special'];
        } else {
            $this->data['special'] = 0;
        }
        ...
        if (isset($this->request->post['product'])) {
            ...
            $this->data['product'] = $information_info['product'];
        } else {
            $this->data['product'] = 0;
        }
