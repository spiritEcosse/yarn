	...
	private function getList() {
		...
		foreach ($results as $result) {
			...
			$this->data['records'][] = array(
				...
				'comment_status' => ($comment['status'] ? $this->language->get('text_enabled') : $this->language->get('text_disabled')),
				'comment_status_reg' => ($comment['status_reg'] ? $this->language->get('text_enabled') : $this->language->get('text_disabled')),
				'comment_status_now' => ($comment['status_now'] ? $this->language->get('text_enabled') : $this->language->get('text_disabled')),
				'comment_rating' => ($comment['rating'] ? $this->language->get('text_enabled') : $this->language->get('text_disabled')),
