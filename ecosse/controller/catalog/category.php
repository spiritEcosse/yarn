...
class ControllerCatalogCategory extends Controller { 
	...
	private function getForm() {
		...
		if (isset($this->request->post['color_text'])) {
			$this->data['color_text'] = $this->request->post['color_text'];
		} elseif (!empty($category_info)) {
			$this->data['color_text'] = $category_info['color_text'];
		} else {
			$this->data['color_text'] = '';
		}

		if (isset($this->request->post['drop_down'])) {
			$this->data['drop_down'] = $this->request->post['drop_down'];
		} elseif (!empty($category_info)) {
			$this->data['drop_down'] = $category_info['drop_down'];
		} else {
