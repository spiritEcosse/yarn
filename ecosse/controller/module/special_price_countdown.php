...
class ControllerModuleSpecialPriceCountDown extends Controller {
	...
	public function index() {   
		...
		$this->data['text_type1'] = $this->language->get('text_type1');
		$this->data['text_type2'] = $this->language->get('text_type2');
		...
		$this->data['entry_type1'] = $this->language->get('entry_type1');
		$this->data['entry_type2'] = $this->language->get('entry_type2');
