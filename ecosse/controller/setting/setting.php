...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        $this->data['text_discount_by_birthday'] = $this->language->get('text_discount_by_birthday');
        $this->data['entry_discount_birthday_days'] = $this->language->get('entry_discount_birthday_days');
        $this->data['text_will_save_sort_order'] = $this->language->get('text_will_save_sort_order');

		$this->data['entry_discount_birthday_enable'] = $this->language->get('entry_discount_birthday_enable');
		...
		$this->data['entry_image_category_menu'] = $this->language->get('entry_image_category_menu');
		...
		$this->data['entry_image_manufacturer_menu'] = $this->language->get('entry_image_manufacturer_menu');
		$this->data['entry_image_manufacturer_main'] = $this->language->get('entry_image_manufacturer_main');
        ...
        $this->data['entry_limit_category_video'] = $this->language->get('entry_limit_category_video');
		...
		if (isset($this->error['image_category_menu'])) {
			$this->data['error_image_category_menu'] = $this->error['image_category_menu'];
		} else {
			$this->data['error_image_category_menu'] = '';
		}
		...
		if (isset($this->error['image_manufacturer_main'])) {
			$this->data['error_image_manufacturer_main'] = $this->error['image_manufacturer_main'];
		} else {
			$this->data['error_image_manufacturer_main'] = '';
		}

		if (isset($this->error['image_manufacturer_menu'])) {
			$this->data['error_image_manufacturer_menu'] = $this->error['image_manufacturer_menu'];
		} else {
			$this->data['error_image_manufacturer_menu'] = '';
		}
        ...
        if (isset($this->error['limit_category_video'])) {
            $this->data['error_limit_category_video'] = $this->error['limit_category_video'];
        } else {
            $this->data['error_limit_category_video'] = '';
        }
		...
		if (isset($this->request->post['discount_birthday_enable'])) {
			$this->data['discount_birthday_enable'] = $this->request->post['discount_birthday_enable'];
		} else {
			$this->data['discount_birthday_enable'] = $this->config->get('discount_birthday_enable');
		}

        if (isset($this->request->post['config_category_video_limit'])) {
            $this->data['config_category_video_limit'] = $this->request->post['config_category_video_limit'];
        } else {
            $this->data['config_category_video_limit'] = $this->config->get('config_category_video_limit');
        }
        ...
        if (isset($this->request->post['discount_birthday_days_products'])) {
            $products = $this->request->post['discount_birthday_days_products'];
        } else {
            $products = $this->config->get('discount_birthday_days_products');
        }

        if (isset($this->request->post['birthday_description'])) {
            $this->data['birthday_description'] = $this->request->post['birthday_description'];
        } else {
            $this->data['birthday_description'] = $this->config->get('birthday_description');
        }
        ...
        if ($products) {
            foreach ($products as $product_id) {
                ...
                $this->data['discount_birthday_days_products'][] = $product;
            }
        }

        if (isset($this->request->post['will_save_sort_order'])) {
            $this->data['will_save_sort_order'] = $this->request->post['will_save_sort_order'];
        } else {
            $this->data['will_save_sort_order'] = $this->config->get('will_save_sort_order');
        }

        if (isset($this->request->post['discount_birthday_days'])) {
            $this->data['discount_birthday_days'] = $this->request->post['discount_birthday_days'];
        } else {
            $this->data['discount_birthday_days'] = $this->config->get('discount_birthday_days');
        }

        if (isset($this->request->post['discount_birthday_subject'])) {
            $this->data['discount_birthday_subject'] = $this->request->post['discount_birthday_subject'];
        } else {
            $this->data['discount_birthday_subject'] = $this->config->get('discount_birthday_subject');
        }

        if (isset($this->request->post['text_info_cart'])) {
            $this->data['text_info_cart'] = $this->request->post['text_info_cart'];
        } else {
            $this->data['text_info_cart'] = $this->config->get('text_info_cart');
        }

        if (isset($this->request->post['discount_birthday_total_price'])) {
            $this->data['discount_birthday_total_price'] = $this->request->post['discount_birthday_total_price'];
        } else {
            $this->data['discount_birthday_total_price'] = $this->config->get('discount_birthday_total_price');
        }

        if (isset($this->request->post['hour_interval'])) {
            $this->data['hour_interval'] = $this->request->post['hour_interval'];
        } else {
            $this->data['hour_interval'] = $this->config->get('hour_interval');
        }
        ...
        if (isset($this->request->post['discount_birthday_one_gift'])) {
            $this->data['discount_birthday_one_gift'] = $this->request->post['discount_birthday_one_gift'];
        } else {
            $this->data['discount_birthday_one_gift'] = $this->config->get('discount_birthday_one_gift');
        }

        if (isset($this->request->post['subject_user_cart'])) {
            $this->data['subject_user_cart'] = $this->request->post['subject_user_cart'];
        } else {
            $this->data['subject_user_cart'] = $this->config->get('subject_user_cart');
        }

        if (isset($this->request->post['text_contact'])) {
            $this->data['text_contact'] = $this->request->post['text_contact'];
        } else {
            $this->data['text_contact'] = $this->config->get('text_contact');
        }

        if (isset($this->request->post['config_comment_status_reg'])) {
            $this->data['config_comment_status_reg'] = $this->request->post['config_comment_status_reg'];
        } else {
            $this->data['config_comment_status_reg'] = $this->config->get('config_comment_status_reg');
        }

        if (isset($this->request->post['config_comment_status_now'])) {
            $this->data['config_comment_status_now'] = $this->request->post['config_comment_status_now'];
        } else {
            $this->data['config_comment_status_now'] = $this->config->get('config_comment_status_now');
        }

        if (isset($this->request->post['config_comment_rating_num'])) {
            $this->data['config_comment_rating_num'] = $this->request->post['config_comment_rating_num'];
        } else {
            $this->data['config_comment_rating_num'] = $this->config->get('config_comment_rating_num');
        }

        if (isset($this->request->post['config_comment_rating'])) {
            $this->data['config_comment_rating'] = $this->request->post['config_comment_rating'];
        } else {
            $this->data['config_comment_rating'] = $this->config->get('config_comment_rating');
        }
		...
		if (isset($this->request->post['config_image_category_menu_width'])) {
			$this->data['config_image_category_menu_width'] = $this->request->post['config_image_category_menu_width'];
		} else {
			$this->data['config_image_category_menu_width'] = $this->config->get('config_image_category_menu_width');
		}

		if (isset($this->request->post['config_image_category_menu_height'])) {
			$this->data['config_image_category_menu_height'] = $this->request->post['config_image_category_menu_height'];
		} else {
			$this->data['config_image_category_menu_height'] = $this->config->get('config_image_category_menu_height');
		}
		...
		if (isset($this->request->post['config_image_manufacturer_menu_width'])) {
			$this->data['config_image_manufacturer_menu_width'] = $this->request->post['config_image_manufacturer_menu_width'];
		} else {
			$this->data['config_image_manufacturer_menu_width'] = $this->config->get('config_image_manufacturer_menu_width');
		}

		if (isset($this->request->post['config_image_manufacturer_menu_height'])) {
			$this->data['config_image_manufacturer_menu_height'] = $this->request->post['config_image_manufacturer_menu_height'];
		} else {
			$this->data['config_image_manufacturer_menu_height'] = $this->config->get('config_image_manufacturer_menu_height');
		}

		if (isset($this->request->post['config_image_manufacturer_width_main'])) {
			$this->data['config_image_manufacturer_width_main'] = $this->request->post['config_image_manufacturer_width_main'];
		} else {
			$this->data['config_image_manufacturer_width_main'] = $this->config->get('config_image_manufacturer_width_main');
		}

		if (isset($this->request->post['config_image_manufacturer_height_main'])) {
			$this->data['config_image_manufacturer_height_main'] = $this->request->post['config_image_manufacturer_height_main'];
		} else {
			$this->data['config_image_manufacturer_height_main'] = $this->config->get('config_image_manufacturer_height_main');
		}
	...
	private function validate() {
		...
		if (!$this->request->post['config_image_category_menu_width'] || !$this->request->post['config_image_category_menu_height']) {
			$this->error['image_category_menu'] = $this->language->get('error_image_category_menu');
		}
		...
		if (!$this->request->post['config_image_manufacturer_menu_width'] || !$this->request->post['config_image_manufacturer_menu_height']) {
			$this->error['image_manufacturer_menu'] = $this->language->get('error_image_manufacturer_menu');
		}



		if (!$this->request->post['config_image_manufacturer_width_main'] || !$this->request->post['config_image_manufacturer_height_main']) {
			$this->error['image_manufacturer_main'] = $this->language->get('error_image_manufacturer_main');
		}
        ...
        if (!$this->request->post['config_category_video_limit']) {
            $this->error['limit_category_video'] = $this->language->get('error_limit');
        }
