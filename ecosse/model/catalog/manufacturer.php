...
class ModelCatalogManufacturer extends Model {
	public function addManufacturer($data) {
      	$this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer SET currency_id='" . (int)$data['currency_id'] . "', name = '" . $this->db->escape($data['name']) . "', sort_order = '" . (int)$data['sort_order'] . "'");
	...
	public function editManufacturer($manufacturer_id, $data) {
      	$this->db->query("UPDATE " . DB_PREFIX . "manufacturer SET currency_id='" . (int)$data['currency_id'] . "', name = '" . $this->db->escape($data['name']) . "', sort_order = '" . (int)$data['sort_order'] . "' WHERE manufacturer_id = '" . (int)$manufacturer_id . "'");
	...
	public function getManufacturerDescriptions($manufacturer_id) {
        ...
        public function getManufactByCategory($category_id) {
            $sql = "select Distinct manufacturer.name, manufacturer.manufacturer_id  from " . DB_PREFIX . "product_to_category, " . DB_PREFIX . "manufacturer, " . DB_PREFIX . "product 
                where product_to_category.category_id='" . (int)$category_id . "' and
                product.manufacturer_id=manufacturer.manufacturer_id and
