...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "information SET sort_order = '" . (int)$data['sort_order'] . "', bottom = '" . (isset($data['bottom']) ? (int)$data['bottom'] : 0) . "', top = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', top_credit = '" . (isset($data['top_credit']) ? (int)$data['top_credit'] : 0) . "', special = '" . (isset($data['special']) ? (int)$data['special'] : 0) . "', product = '" . (isset($data['product']) ? (int)$data['product'] : 0) . "', status = '" . (int)$data['status'] . "'");
	...
	public function editInformation($information_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "information SET sort_order = '" . (int)$data['sort_order'] . "', bottom = '" . (isset($data['bottom']) ? (int)$data['bottom'] : 0) . "', support = '" . (isset($data['support']) ? (int)$data['support'] : 0) . "', info = '" . (isset($data['info']) ? (int)$data['info'] : 0) . "', top = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', top_credit = '" . (isset($data['top_credit']) ? (int)$data['top_credit'] : 0) . "', special = '" . (isset($data['special']) ? (int)$data['special'] : 0) . "', product = '" . (isset($data['product']) ? (int)$data['product'] : 0) . "', status = '" . (int)$data['status'] . "' WHERE information_id = '" . (int)$information_id . "'");
