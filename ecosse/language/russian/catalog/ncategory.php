...
$_['entry_image_display']    = 'Статьи без изображения:<br/><span class="help">Если флажок установлен, то в этой категории все статьи будут отображаться без изображения.</span>';
$_['entry_article_limit']    = 'Лимит статей на странице:<br/><span class="help">Количество статей, отображаемых на странице в этой категории.</span>';
