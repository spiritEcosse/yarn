...
$_['text_discount_by_birthday'] = 'Скидки для именинников';
$_['text_will_save_sort_order'] = 'Вы сэкономили (в корзине):';
...
$_['entry_fax']                = 'Факс:';
$_['entry_skype']               = 'Скайп:';
$_['entry_discount_birthday_enable'] = 'Включить:';
$_['entry_discount_birthday_percent'] = 'Проценты:';
$_['entry_discount_birthday_days'] = 'Количество дней до и после дня рождения:';
...
$_['entry_image_category_menu'] = 'Размер изображения категории в меню:';
...
$_['entry_image_manufacturer_menu'] = 'Размер изображений производителей в меню:';
$_['entry_image_manufacturer_main'] = 'Размер изображений производителей в списке товаров:';
$_['entry_image_manufacturer'] = 'Размер изображений производителей в списке:';
$_['entry_limit_category_video'] = 'Элементов на страницу (Витрина):<br /><span class="help">Количество отображаемых на странице элементов (категории видео)</span>';
...
$_['error_image_category_menu']    = 'Необходимо установить размер изображения в меню!';
...
$_['error_image_manufacturer'] = 'Необходимо установить размер изображения производителей в списке!';
$_['error_image_manufacturer_menu'] = 'Необходимо установить размер изображения производителей в меню!';
$_['error_image_manufacturer_main'] = 'Необходимо установить размер изображения производителей в списке товаров!';
