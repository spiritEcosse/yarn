...
<div style="width: 680px;">
    ...
    <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
        <thead>
        <tr>
            <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: left; padding: 7px; color: #222222;"><?php echo $text_new_comment; ?></td>
        </tr>
        </thead>
        <tbody>
        <tr>
        ...
        <tr>
            ...
            <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;">
                <?php if ($product['gift'] == false) { ?>
                    ...
                    <?php if ($product['diff_price']) { ?>
                        <div><span style="text-decoration: line-through; "><?php echo $product['old_price']; ?></span></div>
            ...
            <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: right; padding: 7px;">
                <?php if ($product['gift'] == true) { ?>
                    <span style="color: red;">Подарок</span>
                <?php } else { ?>
                    <span style="color: red;"><?php echo $product['total']; ?></span>

                    <?php if ($product['diff_price']) { ?>
                        <div><span style="text-decoration: line-through; " class="old_price"><?php echo $product['old_price_total']; ?></span></div>
                    <?php } ?>
                <?php } ?>
            </td>
        </tr>
