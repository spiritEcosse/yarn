...
<?php if (($setting['position'] == 'content_top') || ($setting['position'] == 'content_bottom')){ ?>
  ...
  <a class="all_news" href="<?php echo $LatestNewslist; ?>"><?php echo $buttonlist; ?></a>
		...
		<div class="box-content news-box-content">
		<?php foreach ($LatestNews as $LatestNews_story) { ?>
            ...
            <a title="<?php echo $LatestNews_story['title']; ?>" href="<?php echo $LatestNews_story['href']; ?>"><img src="<?php echo $image_feature; ?>" class="feat_img_small" alt="<?php echo $LatestNews_story['title']; ?>"/></a></span>
            <span><img src="catalog/view/theme/GALKA/image/message-news.png" alt="Date posted" /> - <?php echo $LatestNews_story['posted']; ?></span>
  ...
  <?php if($customtitle) { ?>
		...
		<?php foreach ($LatestNews as $LatestNews_story) { ?>
			...
			<div class="LatestNews-unit">
				...
				<span><img src="catalog/view/theme/GALKA/image/message-LatestNews.png" alt="Date posted" /> - <?php echo $LatestNews_story['posted']; ?></span>
