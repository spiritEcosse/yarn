...
<?php echo $content_top; ?>
 ...
 <?php echo $date_added; ?>
 <ins style="margin-left: 10px;"><img src="/catalog/view/theme/<?php echo $theme; ?>/image/blogstars-<?php echo $rating; ?>.png" alt="<?php echo $comments; ?>" /></ins>
 <span style="float:right;">
 <?php echo $this->language->get('text_feedback'); ?>:<ins style="text-decoration:none;" class="comment_count"><?php echo $comment_count; ?><!--<?php echo $text_comments; ?>--></ins> <ins style="margin-left: 10px;"><?php echo $text_viewed; ?> <?php echo $viewed; ?></ins></span>
 </div>
    ...
    <div class="right">
     ...
     <?php
      ...
      <div class="comment">
        ...
        <div>
        <br>
<a onclick="$('a[href=\'#tab-comment\']').trigger('click');" href="<?php echo $href; ?>#comment-title"><?php echo $this->language->get('text_write_feedback'); ?></a></div>
...
background: #FFF;
  ...
  <div id="tab-comment" class="tab-content">
    <div id="comment" ></div>
    <h2 id="comment-title"><?php echo $this->language->get('text_write_feedback'); ?></h2>
 ...
 <div id="comment_work_0"  style="width: 100%; margin-top: 10px;">
    ...
    <b><ins style="color: #777;"><?php echo $this->language->get('entry_feedback'); ?></ins></b><br>
      ...
      <div>
        ...
        <div class="image">
          <a href="<?php echo $product['href']; ?>">
            <img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" title="<?php echo $product['name']; ?>" /></a></div>
        <?php } ?>
