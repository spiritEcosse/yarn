...
<?php echo $content_top; ?>
 ...
 <?php echo $tab_comment; ?>:<ins style="text-decoration:none;" class="comment_count"><?php echo $comment_count; ?><!--<?php echo $text_comments; ?>--></ins> <ins style="text-decoration: none;margin-left: 10px;"><?php echo $text_viewed; ?> <?php echo $viewed; ?></ins></span>
 </div>
  ...
  <div id="tab-related" class="tab-content">
    <div class="box-product">
      ...
      <div>
        ...
        <div class="rating"><img src="catalog/view/theme/default/image/blogstars-<?php echo $record['rating']; ?>.png" alt="<?php echo $record['comments']; ?>" /></div>
        <?php } ?>
        </div>
      <?php } ?>
    </div>
...
$('#comment .pagination a').live('click', function() {
    ...
    $('#comment').prepend('<div class="attention"><img src="catalog/view/theme/default/image/loading.gif" alt=""> <?php echo $text_wait; ?></div>');
