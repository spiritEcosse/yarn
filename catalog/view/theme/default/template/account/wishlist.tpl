    ...
    <table>
      ...
      <tbody id="wishlist-row<?php echo $product['product_id']; ?>">
        <tr>
          ...
          <td class="action">
              <?php if ($product['price_status'] != 0) { ?>
                    <img src="catalog/view/theme/default/image/cart-add.png" alt="<?php echo $button_cart; ?>" title="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" />&nbsp;&nbsp;<a href="<?php echo $product['remove']; ?>">
              <?php } ?>
