...
if ( isset($products) ) {
  ...
  <div class="box">
	...
	<div>
	  ...
	  <div class="cover boxcaption"><a href="" data-reveal-id="<?php echo $product['product_id']; ?>" data-animation="fade" class="button-detail"><?php echo $button_quick_view; ?></a></div>
		  ...
		  <?php } ?>
	  <div class="name"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?>
	    </a>
	  </div>
	  ...
	  <br>
	      ...
	      <div class="modal">
		    <div class="contents">
			<div class="name"><?php echo $product['name']; ?> &nbsp;&nbsp; <?php echo $text_model; ?> <?php echo $product['model']; ?></div>
  ...
  <!--                          <span><?php //echo $text_stock; ?></span> <?php //echo $product['stock']; ?> -->
		    ...
		    <div class="right">
			  ...
			  <div id="tab-description" class="tab-content" style="display: block"><?php echo $product['description']; ?></div>
  ...
  <div class="box">
	...
	<div>
	  ...
	  <?php } ?>
	  <?php if ($product['thumb']) { ?>
	  <div class="image" style="padding: 0 0 0 4px;"><a href="<?php echo $product['href']; ?>"><img  src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" /></a></div>
	  <?php } ?>
		  <div class="name"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?>
