...
// Text
$_['text_cart']                      = 'Корзина';
$_['text_checkout_option']           = 'Шаг 1: Выбор способа оформить заказ';
...
$_['text_checkout_confirm']          = 'Шаг 6: Подтвердить заказ';
...
$_['text_error_city']                = 'Пожалуйста укажите город!';
$_['text_error_depart']                = 'Пожалуйста укажите отделение!';
$_['text_comments']                  = 'Вы можете добавить комментарий к своему заказу:';
$_['text_none']                     = ' --- Не выбрано --- ';
$_['text_birthday'] = '<span class="red">Подарок</span>';
