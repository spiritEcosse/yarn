...
class ControllerModuleAccount extends Controller {
	protected function index() {
        ...
        $this->data['href_discount_birthday'] = $this->url->link('account/gifts', '', 'SSL');
        ...
        if ($this->config->get('discount_birthday_enable') == 1 && count($this->config->get('discount_birthday_days_products')) > 0 && $this->config->get('birthday_description')) {
