	...
	public function index() { 
		...
		if ($category_info) {
			...
			foreach ($results as $result) {
				...
				$descr_plaintext = preg_replace ('/<img.*>/Uis', '', $descr_plaintext);
				$cut_descr_symbols = strpos($descr_plaintext, '<table', 0);
			        $descr_plaintext_test = mb_strcut($descr_plaintext, 0, $cut_descr_symbols, 'UTF-8');
                                $descr_plaintext_test = preg_replace("'([\r\n])[\s]+'", " ", $descr_plaintext_test);
				preg_match("/<table.*?<\/table>/si",$descr_plaintext, $descr_plaintext); 
				$descr_plaintext = implode("", $descr_plaintext);
//                                $descr_plaintext .= $descr_plaintext_test;
