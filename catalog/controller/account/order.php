...
class ControllerAccountOrder extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->get['order_id'])) {
			...
			if ($order_info) {
				...
				foreach ($order_products as $order_product) {
					...
					$this->cart->add($order_product['product_id'], $order_product['quantity'], $option_data, $order_product['product_price_id']);
				}
		...
		foreach ($results as $result) {
			...
			$this->data['orders'][] = array(
                ...
                'order_cancel' => $this->url->link('account/order/deleteOrder', '&order_id=' . $result['order_id'], 'SSL'),
		...
		$this->fileRender('/template/account/order_list.tpl');
	}
	...
	public function info() { 
		...
		if ($order_info) {
            ...
            $this->data['text_order_cancel'] = $this->language->get('text_order_cancel');
            $this->data['order_cancel'] = $this->url->link('account/order/deleteOrder', '&order_id=' . $this->request->get['order_id'], 'SSL');

      		$this->data['continue'] = $this->url->link('account/order', '', 'SSL');
			$file = '/template/account/order_info.tpl';
    	} else {
			$this->document->setTitle($this->language->get('text_order'));
    ...
    public function deleteOrder() {
        $this->language->load('account/order');
        $this->session->data['success'] = sprintf($this->language->get('text_success_order_cancel'), $this->request->get['order_id']);
