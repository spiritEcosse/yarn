...
include_once(DIR_SYSTEM . 'library/LiqPay.php');
...
class ControllerPaymentLiqpay extends Controller
{
    ...
    protected function index() {
        ...
        $data = array(
            ...
            'sandbox'        => $this->config->get('liqpay_test'),
            'language'       => $language
        );

        $liqpay = new LiqPay($public_key, $private_key);
        $this->data['data'] = $liqpay->cnb_form($data);

        $liqpay = new LiqPay($public_key, $private_key);
        $this->data['signature'] = $liqpay->cnb_signature($data);
